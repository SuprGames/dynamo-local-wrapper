...
object AwsDynamoDbLocalTestUtils {
     ...
     * @return
     */
    private fun getLibPath(osName: String?, runtimeName: String?, osArch: String?, classPath: List<String>): String {
 ...
 * class](https://bitbucket
     ...
     */
    private fun getLibNames(os: String, arch: String): List<String> {
     ...
     */
    private fun getArch(os: String, osArch: String?): String {
        var result: String
        if (osArch == null) {
            result = "x86"
        } else {
     ...
     *
     * Based on the internal calculation of the sqlite4java wrapper [Internal class]
     * (https://bitbucket.org/almworks/sqlite4java/src/fa4bb0fe7319a5f1afe008284146ac83e027de60/java/com/almworks/
     *                          sqlite4java/Internal.java?at=master&fileviewer=file-view-default#Internal.java-219)
     *
     * @param osName      The value of `"os.name"` system property (`System.getProperty("os.name")`).
     * @param runtimeName The value of `"java.runtime.name"` system property (`System.getProperty("java.runtime.name")`).
     * @return Operating System Name used by sqlite4java to get native library.
     */
    private fun getOs(osName: String?, runtimeName: String?): String {
        val result: String
     ...
     */
    private fun getClassPathList(classPath: String, pathSeparator: String): List<String> {
